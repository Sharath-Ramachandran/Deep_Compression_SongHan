...
class MaskedLinear(Module):
    ...
    def __init__(self, in_features, out_features, bias=True):
        ...
        #print("In Feature",self.in_features)
        #print("Out Feature",self.out_features)
    ...
    def prune(self, threshold):
        ...
        #print("Convert Tensors to numpy and calculate")
