...
class AlexNet(PruningModule): # input size is 227*227*3

    def __init__(self, mask=False):
        super(AlexNet, self).__init__()
        linear = MaskedLinear if mask else Linear
        self.features = nn.Sequential(
            nn.Conv2d(3, 64, kernel_size=11, stride=4, padding=2), # for mnist, we gave input channel as 1
